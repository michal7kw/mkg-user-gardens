...
created: '2026-08-05T23:39:08.643764Z'
...
permalink: /garden/testuser1d1b1dfaf/users_guide/understanding-the-vault/
provenance: curated
...
type: users_guide
updated: '2026-08-05T23:39:08.643764Z'
---
...
<li>Files must have proper YAML frontmatter to sync (see <a href="/garden/testuser1d1b1dfaf/users_guide/creating-entities/" class="internal-link">Creating Entities</a>)</li>
</ul>
...
<li>Relationships defined in the note body (see <a href="/garden/testuser1d1b1dfaf/users_guide/relationships-and-links/" class="internal-link">Relationships and Links</a>)</li>
</ul>
...
<p>Contains markdown templates for each entity type. When you create a new entity using the wizard (see <a href="/garden/testuser1d1b1dfaf/users_guide/creating-entities/" class="internal-link">Creating Entities</a>), the appropriate template is applied automatically. Templates include:</p>
<ul>
...
<h2>Next Steps</h2>
<ul>
<li><a href="/garden/testuser1d1b1dfaf/users_guide/creating-entities/" class="internal-link">Creating Entities</a> — Learn how to create new entity notes</li>
<li><a href="/garden/testuser1d1b1dfaf/users_guide/relationships-and-links/" class="internal-link">Relationships and Links</a> — Connect entities with typed relationships</li>
<li><a href="/garden/testuser1d1b1dfaf/users_guide/syncing-with-neo4j/" class="internal-link">Syncing with Neo4j</a> — Sync your vault with the knowledge graph database</li>
</ul>
