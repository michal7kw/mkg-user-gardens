...
permalink: /garden/itest6dcac468/biomarker/plasma-amyloid-beta-ratio/
provenance: curated
...
<p>ASSOCIATED_WITH_CONDITION::<a href="/garden/itest6dcac468/condition/alzheimers-disease/" class="internal-link">Alzheimer's Disease</a> - principal clinical use; pAβ42/40 is a non-invasive screening biomarker for brain amyloid pathology<br />
ASSOCIATED_WITH_CONDITION::<a href="/garden/itest6dcac468/condition/mild-cognitive-impairment/" class="internal-link">Mild Cognitive Impairment</a> - abnormal pAβ42/40 in MCI predicts progression to AD dementia</p>
<h3>INDICATES_ORGAN_HEALTH</h3>
<p>INDICATES_ORGAN_HEALTH::<a href="/garden/itest6dcac468/organ/brain/" class="internal-link">Brain</a> - reflects brain amyloid pathology non-invasively</p>
<h3>PREDICTS_RISK</h3>
<p>PREDICTS_RISK::<a href="/garden/itest6dcac468/condition/alzheimers-disease/" class="internal-link">Alzheimer's Disease</a> - abnormal pAβ42/40 detected 10-15 years before symptoms</p>
<h3>CORRELATED_WITH</h3>
<p>CORRELATED_WITH::<a href="/garden/itest6dcac468/biomarker/plasma-p-tau217/" class="internal-link">Plasma p-tau217</a> - complementary blood biomarker; combining Aβ42/40 + p-tau217 yields AUC ~0.95 for brain amyloid detection<br />
CORRELATED_WITH::<a href="/garden/itest6dcac468/biomarker/total-tau/" class="internal-link">Total Tau</a> - CSF t-tau remains the &quot;neurodegeneration&quot; marker in the AT(N) framework; plasma Aβ42/40 measures the &quot;A&quot;<br />
CORRELATED_WITH::<a href="/garden/itest6dcac468/biomarker/gfap/" class="internal-link">GFAP</a> - astrocyte activation marker; co-elevated with low pAβ42/40 in amyloid-positive individuals<br />
CORRELATED_WITH::<a href="/garden/itest6dcac468/biomarker/neurofilament-light-chain/" class="internal-link">Neurofilament Light Chain</a> - axonal injury marker; complementary for staging<br />
CORRELATED_WITH::<a href="/garden/itest6dcac468/biomarker/blood-nfl/" class="internal-link">Blood NfL</a> - blood-based NfL; complementary</p>
<h3>PARTICIPATES_IN_PATHWAY</h3>
<p>PARTICIPATES_IN_PATHWAY::<a href="/garden/itest6dcac468/pathway/oxidative-phosphorylation/" class="internal-link">Oxidative Phosphorylation</a> - amyloid pathology is associated with mitochondrial dysfunction; amyloid-beta disrupts ETC and increases ROS</p>
<h2>References</h2>
<ul>
