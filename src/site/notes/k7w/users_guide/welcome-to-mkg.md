...
aliases:
- 00_Welcome
created: '2026-06-15T07:14:47.642063Z'
description: Overview of the MKG platform — what it does, who it's for, and what's
  possible
dg-home: false
dg-publish: true
gardenUsername: k7w
permalink: /garden/k7w/users_guide/welcome-to-mkg/
slug: welcome-to-mkg
tags:
- users_guide
- documentation
...
type: users_guide
updated: '2026-06-15T07:14:47.642063Z'
---
...
<h2>Next Steps</h2>
<p>Ready to get started? Head to <a href="/garden/k7w/users_guide/getting-started/" class="internal-link">Getting Started</a> to set up your vault and plugin.</p>
<p>Want to understand the vault structure first? See <a href="/garden/k7w/users_guide/understanding-the-vault/" class="internal-link">Understanding the Vault</a>.</p>
<p>Prefer to explore the web dashboard? See <a href="/garden/k7w/users_guide/web-dashboard-tour/" class="internal-link">Web Dashboard Tour</a>.</p>
