...
aliases:
- 14_Troubleshooting
created: '2026-06-15T07:14:47.810065Z'
description: Common issues with connections, sync, plugin, and the web dashboard —
  plus FAQ
dg-home: false
dg-publish: true
gardenUsername: k7w
permalink: /garden/k7w/users_guide/troubleshooting/
...
type: users_guide
updated: '2026-06-15T07:14:47.810065Z'
---
...
<p><strong>Solutions:</strong></p>
<ul>
<li>Have you synced your vault? See <a href="/garden/k7w/users_guide/syncing-with-neo4j/" class="internal-link">Syncing with Neo4j</a></li>
...
<li>Compare your field names with the examples in <a href="/garden/k7w/users_guide/creating-entities/" class="internal-link">Creating Entities</a></li>
...
<p>If you're stuck:</p>
<ol>
<li><strong>Check this guide</strong> — Search for your issue in <a href="/garden/k7w/users_guide/troubleshooting/" class="internal-link">Troubleshooting</a> (you're here)</li>
...
<h2>Next Steps</h2>
<ul>
<li><a href="/garden/k7w/users_guide/getting-started/" class="internal-link">Getting Started</a> — Revisit setup if you're having configuration issues</li>
<li><a href="/garden/k7w/users_guide/syncing-with-neo4j/" class="internal-link">Syncing with Neo4j</a> — Detailed sync troubleshooting</li>
<li><a href="/garden/k7w/users_guide/tips-and-best-practices/" class="internal-link">Tips and Best Practices</a> — Prevent common issues by following best practices</li>
</ul>
