...
permalink: /garden/skiptest/metabolite/nad/
provenance: curated
pubchem_id: '5892'
slug: nad
source: PubMed
...
title: NAD+
type: metabolite
updated: '2026-08-04T00:43:37.993065Z'
---

{% raw %}
<h1>NAD+</h1>
<h2>Overview</h2>
<p>Nicotinamide adenine dinucleotide (NAD+) is one of the most fundamental small molecules in cellular biochemistry. In its oxidized form (NAD+) it accepts a hydride to become the reduced form (NADH), shuttling electrons through <a href="/garden/skiptest/pathway/glycolysis/" class="internal-link">Glycolysis</a>, the <a href="/garden/skiptest/pathway/citric-acid-cycle/" class="internal-link">Citric Acid Cycle</a>, and <a href="/garden/skiptest/pathway/oxidative-phosphorylation/" class="internal-link">Oxidative Phosphorylation</a> to power ATP synthesis. Beyond this classical redox role, NAD+ is consumed as a substrate by three major enzyme families — sirtuins, poly(ADP-ribose) polymerases (PARPs), and the NADases CD38/CD157 — coupling the cell's energy state to gene expression, DNA repair, and immune signaling.</p>
...
<ul>
<li><strong>Salvage pathway</strong> (~85% of supply): recycles nicotinamide released by NAD+-consuming enzymes via NAMPT (rate-limiting) and NMNAT — see <a href="/garden/skiptest/pathway/nad-salvage-pathway/" class="internal-link">NAD+ Salvage Pathway</a>.</li>
<li><strong>De novo synthesis from tryptophan:</strong> the terminal branch of the <a href="/garden/skiptest/pathway/kynurenine-pathway/" class="internal-link">Kynurenine Pathway</a> converts tryptophan-derived quinolinic acid to NAD+ via QPRT — see <a href="/garden/skiptest/pathway/de-novo-nad-synthesis-pathway/" class="internal-link">De Novo NAD+ Synthesis Pathway</a>.</li>
...
<ul>
<li><strong>Longevity &amp; metabolism:</strong> NAD+ availability gates <a href="/garden/skiptest/pathway/sirtuin-signaling-pathway/" class="internal-link">Sirtuin Signaling Pathway</a> activity, which regulates mitochondrial biogenesis, lipid metabolism, and insulin sensitivity.</li>
<li><strong>Neurodegeneration:</strong> NAD+ depletion impairs neuronal energy metabolism and is implicated in <a href="/garden/skiptest/condition/cognitive-dysfunction/" class="internal-link">Cognitive Dysfunction</a> and <a href="/garden/skiptest/condition/mild-cognitive-impairment/" class="internal-link">Mild Cognitive Impairment</a>; axonal NAD+ loss drives degeneration.</li>
...
<p>PARTICIPATES_IN::<a href="/garden/skiptest/pathway/nad-salvage-pathway/" class="internal-link">NAD+ Salvage Pathway</a><br />
PARTICIPATES_IN::<a href="/garden/skiptest/pathway/de-novo-nad-synthesis-pathway/" class="internal-link">De Novo NAD+ Synthesis Pathway</a><br />
PARTICIPATES_IN::<a href="/garden/skiptest/pathway/kynurenine-pathway/" class="internal-link">Kynurenine Pathway</a><br />
PARTICIPATES_IN::<a href="/garden/skiptest/pathway/glycolysis/" class="internal-link">Glycolysis</a><br />
PARTICIPATES_IN::<a href="/garden/skiptest/pathway/citric-acid-cycle/" class="internal-link">Citric Acid Cycle</a><br />
...
<h3>Redox Partner</h3>
<p>CONVERTS_TO::<a href="/garden/skiptest/metabolite/nadh/" class="internal-link">NADH</a></p>
<h3>Activates</h3>
<p>ACTIVATES::<a href="/garden/skiptest/pathway/sirtuin-signaling-pathway/" class="internal-link">Sirtuin Signaling Pathway</a></p>
<h3>Modulated By Supplement</h3>
<p>MODULATED_BY_SUPPLEMENT::<a href="/garden/skiptest/supplement/nmn/" class="internal-link">NMN</a><br />
MODULATED_BY_SUPPLEMENT::<a href="/garden/skiptest/supplement/niacin/" class="internal-link">Niacin</a></p>
<h3>Related Metabolites</h3>
<p>RELATED_TO::<a href="/garden/skiptest/supplement/nicotinamide-riboside/" class="internal-link">Nicotinamide Riboside</a></p>
...
ASSOCIATED_WITH_CONDITION::<a href="/garden/skiptest/condition/mild-cognitive-impairment/" class="internal-link">Mild Cognitive Impairment</a></p>
<h2>References</h2>
<ul>
