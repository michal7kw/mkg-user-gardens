...
<p>The <a href="/garden/demo_user/pathway/nf-kb-pathway/" class="internal-link">NF-kB Pathway</a> plays a complex dual role in apoptosis regulation, often promoting cell survival by upregulating anti-apoptotic genes. Understanding the balance between pro-survival and pro-death signaling is central to modern cancer therapy, where strategies aim to selectively reactivate apoptosis in tumor cells while sparing normal tissue. BH3 mimetics, death receptor agonists, and caspase activators represent active areas of drug development.</p>
<h2>Key Mechanisms</h2>
<ul>
<li><strong>Intrinsic pathway</strong>: Mitochondrial outer membrane permeabilization by Bax/Bak releases <a href="/garden/demo_user/protein/cytochrome-c/" class="internal-link">Cytochrome C</a>, forming the apoptosome</li>
...
<h2>Relationships</h2>
<p>INVOLVES::<a href="/garden/demo_user/cellularcomponent/mitochondria/" class="internal-link">Mitochondria</a><br />
INVOLVES::<a href="/garden/demo_user/protein/cytochrome-c/" class="internal-link">Cytochrome C</a><br />
REGULATED_BY::<a href="/garden/demo_user/pathway/nf-kb-pathway/" class="internal-link">NF-kB Pathway</a><br />
