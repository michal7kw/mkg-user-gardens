...
<li><strong>Targeted supplementation</strong> — <a href="/garden/demo_user/supplement/berberine/" class="internal-link">Berberine</a> (strongest evidence; comparable to metformin in some studies), <a href="/garden/demo_user/supplement/alpha-lipoic-acid/" class="internal-link">Alpha Lipoic Acid</a>, <a href="/garden/demo_user/supplement/chromium/" class="internal-link">Chromium</a>, <a href="/garden/demo_user/supplement/magnesium/" class="internal-link">Magnesium</a> (if deficient), and <a href="/garden/demo_user/supplement/vitamin-d/" class="internal-link">Vitamin D</a> (if deficient)</li>
</ol>
<h2>Relationships</h2>
