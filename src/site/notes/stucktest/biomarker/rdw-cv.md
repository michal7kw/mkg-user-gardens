...
permalink: /garden/stucktest/biomarker/rdw-cv/
provenance: curated
slug: rdw-cv
source: Manual
tags:
...
<ul>
<li><strong><a href="/garden/stucktest/condition/iron-deficiency-anemia/" class="internal-link">Iron Deficiency Anemia</a></strong>: High RDW is a hallmark; distinguishes it from thalassemia trait (normal RDW) when both are microcytic.</li>
<li><strong><a href="/garden/stucktest/condition/pernicious-anemia/" class="internal-link">Pernicious Anemia</a></strong>: B12 malabsorption produces megaloblastic macrocytes, widening the distribution.</li>
<li><strong><a href="/garden/stucktest/condition/cardiovascular-disease/" class="internal-link">Cardiovascular Disease</a></strong>: An independent prognostic marker—elevated RDW predicts worse outcomes and increased all-cause mortality in heart failure and coronary disease, even after adjusting for hemoglobin and inflammatory markers.</li>
</ul>
...
<ol>
<li><strong>Correct Iron Deficiency:</strong> When RDW is high with low ferritin/MCV, repleting <a href="/garden/stucktest/supplement/iron/" class="internal-link">Iron</a> (oral or IV) normalizes erythropoiesis; RDW typically falls as the homogeneous, iron-replete cohort replaces the mixed population over 4-8 weeks.</li>
<li><strong>Replete B12 / Folate:</strong> When macrocytosis accompanies a high RDW, <a href="/garden/stucktest/supplement/vitamin-b12/" class="internal-link">Vitamin B12</a> and <a href="/garden/stucktest/supplement/folate/" class="internal-link">Folate</a> supplementation restores normal DNA synthesis, allowing uniform cell production and a declining RDW.</li>
<li><strong>Confirm With Paired Indices:</strong> Always interpret RDW with <a href="/garden/stucktest/biomarker/mcv/" class="internal-link">Mcv</a> and <a href="/garden/stucktest/labtest/ferritin/" class="internal-link">Ferritin</a>; a falling RDW after treatment is a useful confirmation that the targeted deficiency was the cause.</li>
...
INDICATES_ORGAN_HEALTH::<a href="/garden/stucktest/organ/bone-marrow/" class="internal-link">Bone Marrow</a></p>
...
ASSOCIATED_WITH_CONDITION::<a href="/garden/stucktest/condition/pernicious-anemia/" class="internal-link">Pernicious Anemia</a><br />
...
<p>CORRELATED_WITH::<a href="/garden/stucktest/biomarker/mcv/" class="internal-link">Mcv</a><br />
CORRELATED_WITH::<a href="/garden/stucktest/labtest/ferritin/" class="internal-link">Ferritin</a><br />
CORRELATED_WITH::<a href="/garden/stucktest/supplement/iron/" class="internal-link">Iron</a></p>
...
AFFECTED_BY_SUPPLEMENT::<a href="/garden/stucktest/supplement/folate/" class="internal-link">Folate</a></p>
<h3>Included In</h3>
