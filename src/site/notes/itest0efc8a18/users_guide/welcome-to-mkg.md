...
type: users_guide
updated: '2026-08-06T03:11:42.926447Z'
---
...
<h2>Next Steps</h2>
<p>Ready to get started? Head to <a href="/garden/itest0efc8a18/users_guide/getting-started/" class="internal-link">Getting Started</a> to set up your vault and plugin.</p>
<p>Want to understand the vault structure first? See <a href="/garden/itest0efc8a18/users_guide/understanding-the-vault/" class="internal-link">Understanding the Vault</a>.</p>
<p>Prefer to explore the web dashboard? See <a href="/garden/itest0efc8a18/users_guide/web-dashboard-tour/" class="internal-link">Web Dashboard Tour</a>.</p>
