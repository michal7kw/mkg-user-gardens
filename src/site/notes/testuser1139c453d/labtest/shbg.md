---
aliases:
- sex_hormone_binding_globulin_shbg
...
country_availability:
  it:
    ...
    localized_name: SHBG (globulina legante gli ormoni sessuali)
    typical_providers:
  ...
  pl:
    ...
    last_verified: 2026-05
    localized_name: SHBG (globulina wiążąca hormony płciowe)
    typical_providers:
  ...
  uk:
    ...
    exemptions: []
    last_verified: 2026-05
    localized_name: Sex Hormone Binding Globulin (SHBG)
    typical_providers:
...
id: test-shbg-001
permalink: /garden/testuser1139c453d/labtest/shbg/
provenance: curated
slug: shbg
source: Manual
tags:
...
title: shbg
type: labtest
updated: '2026-08-05T02:04:36.087812Z'
---

{% raw %}
<h1>shbg</h1>
<h2>Overview</h2>
<p>Binds testosterone and estrogen. Important for calculating free hormone levels and assessing metabolic health.</p>
...
<h2>Relationships</h2>
<p>RELATED::<a href="/garden/testuser1139c453d/hormone/testosterone/" class="internal-link">Testosterone</a></p>
<h2>Notes</h2>
<ul>
